                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <div class="pull-right">
                                    ...
                                    $student_query=mysqli_query($conn,"select * from student where student_id='$session_id'")or die(mysqli_error($conn));
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-success"><i class="icon-user icon-large"></i>&nbsp; <?php echo $user_row['lastname'] . " " . $user_row['firstname']; ?></button>
