...
<div class="hero-unit-3">
	 ...
	 $total=mysqli_num_rows($query);
		 ...
		 ?>
         <div class="alert alert-info"><b>Current Results:</b>&nbsp;Year&nbsp;<?php echo $preqry['stud_year'];  ?>&nbsp;, Semester:<?php echo $preqry['studsem']   ?>&nbsp;<b><?php if(($exam_sem_num)==1)echo "Jan-June"; else echo"July-Dec"; ?>&nbsp;&nbsp;<?php  echo $exam_num_year?></b> </div>
                                   <p> 
                                  <a href="toPDF.php" class="btn btn-success"><i class="icon icon-undo"></i>Export Results</a>
								  </p>
