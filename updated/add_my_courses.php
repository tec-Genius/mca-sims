            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                       ...
                       <a href="add_student_new.php" class="btn btn-success"><i class="icon-align-justify icon-large"></i>&nbsp;Add New Student</a>
                       <p>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
  ...
  Or Search By Name
                                ...
                                <tbody>
									...
									$q=$_POST['users'];
                                    $query = mysqli_query($conn,"select * from student where cys='$q'");
                                    while ($row = mysqli_fetch_array($query)) {
                                        $student_id = $row['student_id'];
										$id=$row['id'];
										$p=$row['cys'];
										$query2 = mysqli_query($conn,"select * from course where course_id='$p'");
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td width="150">
                                           ...
                                           <a rel="tooltip"  title="Add courses" id="a<?php echo $id; ?>" href="add_student_subject.php?id=<?php echo $id; ?>" class="btn btn-success" role="button"  data-toggle="modal" ><i class="icon-large"></i><i class="icon-plus-sign-alt icon-large"></i></a>
                                   ...
                                   <div id="view<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        echo "<b>Phone number:</b>"." &nbsp;&nbsp; ". $row['stud_pnone'] ." ". "<br><b>Student Email:</b>"."   ". $row['stud_email']."<br>";
										 echo "<b>Student address:</b>"." &nbsp;&nbsp;  ". $row['stud_address'] ."  ". "<br><b>Birth date:</b>"."   ". $row['birth_date']."<br>";
										  echo "<b>Adimission year:</b>"."&nbsp;&nbsp;   ". $row['addm_year'] ."  ". "<br><b>Program:</b>"."   ". $row['cys']."<br><b>Semester:</b>"."   ". $row['sem']."<br>";
