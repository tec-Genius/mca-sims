                    ...
                    <form class="form-horizontal" method="POST">
                        ...
                        <div class="control-group">
                            ...
                            if (isset($_POST['save_subject'])) {
                                ...
                                $result = mysqli_query($conn,"select * from teacher_suject where teacher_id='$session_id' and subject_id='$subject'") or die(mysqli_error($conn));
                                ...
                                if ($count > 0) {
                                    ...
                                    mysqli_query($conn,"insert into teacher_suject (subject_id,teacher_id) values('$subject','$session_id')") or die(mysqli_error($conn));
