...
include('header.php');
include ('session.php');
$user_query = mysqli_query($conn,"select * from student where student_id='$session_id'") or die(mysqli_error($conn));
$user_row = mysqli_fetch_array($user_query);
?>

<?php
$query_class = mysqli_query($conn,"select * from class where class_id='$get_id'") or die(mysqli_error($conn));
$row_class = mysqli_fetch_array($query_class);
$teacher_id = $row_class['teacher_id'];

$teacher_query=mysqli_query($conn,"select *from teacher where teacher_id='$teacher_id'")or die(mysqli_error($conn));
            ...
            <div class="span9">
                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            <?php
                            $query = mysqli_query($conn,"select * from files where class_id = '$get_id'") or die(mysqli_error($conn));
