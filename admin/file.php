                           ...
                           if($int){
                                ...
                                <div class="alert alert-info">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                     <strong><i class="icon-user icon-large"></i>&nbsp;Student fees &nbsp; </strong>
                                </div>
                                ...
                                Or Choose Programme&nbsp;<select name="prog"  required>
                                 ...
                                 <a href="file2.php"  class="btn btn-success" style="margin-left:5px;margin-top:3px">Enter previous fees</a>
...
{
                                   $student=mysqli_query($conn,"select * from student where cys='$q' order by  addm_year desc") or die(mysqli_error($conn));
}
