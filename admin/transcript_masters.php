...
<li class="dropdown">
 ...
 <li>
                    ...
                    <?php include"msg.php"?>
                    <div class="span12" style="border:1px; width:78%; margin-left:22%; margin-top:-445px;">
                    <?php if(($l==1) or ($l==2) or ($l==9) ){?>
                        <!--slider-->
                  <form method="get" action="transrepo_masters.php">  
              ...
              &nbsp;&nbsp;<a href="#v"  data-toggle="modal" ><button class="btn btn-success" type="button"  id="arc" ><i class="icon-plus-sign icon-large"></i>&nbsp;<font color="#FFFFFF">Archive transcript</font></button></a>
                ...
                <?php  }?>
                <?php if (isset($_COOKIE['ERR'])) echo"<div class='alert alert-danger'> &nbsp;$_COOKIE[ERR]</div>"; unset($_COOKIE['ERR']);?>
                <!-- user delete modal -->
                ...
                <?php if(isset($msg)){?>
                            ...
                            <strong><i class="icon-user icon-large"></i>&nbsp;Student Transcript <i class="icon-double-angle-right icon-large"></i>Masters</strong>                      </div> 
           ...
           <form action="" method="get">
                                            ...
                                            <?php
                                            $query = mysqli_query($conn,"select *  from student where stud_current_year='2'  and current_sem='2' and category='1' order by lastname ASC ");
     ...
     <form id="form1">
    <div id="dvContainer">
    <table cellpadding="0" cellspacing="0"  width="100%" id="d"  style="font-size:11pt; font-family:'Times New Roman'; background:url(images/watermak2.png )  center" cellpadding="0"  cellspacing="0" align="center" >
