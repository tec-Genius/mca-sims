...
?>
<tr bgcolor="#DDDDDD" ><td colspan="5" class="alert alert-info"><b></b>TOTAL REVENUE COLLECTED IN THE SEMESTER</td><th bgcolor="blue"><font color="white" >MWK<?php echo number_format($sum);?></font> </th><td colspan="2"></td></tr>
<?php
}//close  
}//close if fees=4
if($_GET['fees']==3)
